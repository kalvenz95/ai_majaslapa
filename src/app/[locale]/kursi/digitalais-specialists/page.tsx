            ...
            <div style={{ background: `rgba(${PLAN.glow},0.08)`, padding: "20px 24px", borderBottom: `1px solid rgba(${PLAN.glow},0.15)` }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <span style={{ fontSize: 15, fontWeight: 800, color: PLAN.color }}>€1 000–€3 600/mēn</span>
                </div>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <span style={{ fontSize: 18, fontWeight: 900, color: PLAN.color }}>€2 000–€7 200/mēn</span>
                </div>
              </div>
            </div>
