...
import { websiteChatbotMarketingCourseByLocale } from "@/content/marketing/websiteChatbotMarketingCourseByLocale";
import { WebsiteChatbotOverviewPanel } from "@/components/marketing/WebsiteChatbotOverviewPanel";
import {
...
import { websiteChatbotOverviewByLocale } from "@/content/marketing/websiteChatbotOverview.byLocale";
...
const theme = CHATBOT_MARKET_THEME;
...
export default function CourseDetailPage() {
  ...
  const course = websiteChatbotMarketingCourseByLocale[locale];
  const wcOv = websiteChatbotOverviewByLocale[locale];
          ...
          {activeLesson ? (
            ...
            <div>
              ...
              <div className="course-content" style={{ padding: "40px 48px", maxWidth: 900 }}>
                {activeTab === "overview" && <WebsiteChatbotOverviewPanel course={course} overview={wcOv} m={m} />}
