...
const TEMPLATES = [
  ...
  { icon: "🎙️", title: "Voice aģenta sistēmas prompt", cat: "Prompt", ver: "v1.2", size: "0.5 KB" },
  ...
  { icon: "🎙️", title: "Vapi balss aģenta sistēmas prompt (LV)", cat: "Prompt", ver: "v1.0", size: "0.7 KB" },
