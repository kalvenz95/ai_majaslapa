...
const course = {
  ...
  subtitle: "Inteliģents AI chatbot uzņēmumu mājaslapās",
  description:
    "Iemācies veidot AI chatbotu, kas automātiski atbild uz klientu jautājumiem 24/7 — ar Voiceflow bez koda vai ar n8n un Claude API pilnīgai kontrolei. Gatavs pakalpojums, ko pārdot Latvijas uzņēmumiem par €300–€800 mēnesī.",
  earn: "€300–€800/mēn",
  difficulty: "Vidējs",
  ...
  instructor: {
    ...
    avatar: "KB",
    bio: "5+ gadi digitālā mārketingā, pēdējos 2 gadus specializējoties AI risinājumos Latvijas uzņēmumiem. Uzstādījis 40+ chatbotus dažādām nišām — e-veikali, pakalpojumi, medicīna.",
    students: 420,
    courses: 3,
  },
  tools: [
    { name: "Voiceflow",     desc: "No-code AI chatbot veidotājs",   color: "#00ff88" },
    { name: "n8n",           desc: "Automatizācijas backend",          color: "#00d4ff" },
    { name: "Claude API",    desc: "Anthropic AI modelis",             color: "#a855f7" },
    { name: "Tidio",         desc: "Live chat + chatbot platforma",    color: "#00ff88" },
    { name: "JavaScript",    desc: "Custom widget izveide",            color: "#f59e0b" },
    { name: "Google Sheets", desc: "Sarunu vēstures glabāšana",       color: "#22c55e" },
    { name: "Framer / WP",   desc: "Embed integrācija mājaslapā",     color: "#ec4899" },
  ],
  learn: [
    "Izveidot pilnfunkcionālu AI chatbotu bez kodēšanas ar Voiceflow",
    "Savienot chatbotu ar Claude API caur n8n workflow",
    "Veidot Knowledge Base no klienta mājas lapas satura",
    "Iegult chatbotu Framer, WordPress un jebkurā HTML lapā",
    "Iestatīt lead ievākšanu — vārds, e-pasts, vajadzības",
    "Pārdot chatbot pakalpojumu par €300–€800 vienreizēji",
    "Piedāvāt €50–120/mēn apkopes pakalpojumu",
    "Izveidot demo chatbotu, kas pats pārdod pakalpojumu",
  ],
  modules: [
    {
      id: 1,
      ...
      duration: "50 min",
      lessons: [
        { id: "1-1", title: "Kas ir website chatbot un kāpēc tas strādā?", type: "video" as LessonType, duration: "14 min", free: true, description: "Salīdzinājums: kontaktforma vs telefons vs AI chatbot. Stats, konversijas rādītāji un reāli Latvijas piemēri." },
        { id: "1-2", title: "Rīku saraksts & konta setup", type: "video" as LessonType, duration: "10 min", free: true, description: "Voiceflow, n8n, Anthropic un Tidio kontu izveide. Bezmaksas plāni un ko tie ietver." },
        { id: "1-3", title: "Klienta onboarding process", type: "text" as LessonType, duration: "8 min", description: "Lejupielādējams onboarding template — jautājumi par klienta biznesu, mērķauditoriju un biežākajiem klientu jautājumiem." },
        { id: "1-4", title: "Kā noteikt cenas chatbot pakalpojumam", type: "video" as LessonType, duration: "18 min", description: "Vienreizējā maksa vs ikmēneša apkope. Kāpēc €300+ ir saprātīgi sākumā un kā augt uz €800+/projektu." },
      ],
    },
    {
      id: 2,
      ...
      duration: "1h 25 min",
      lessons: [
        { id: "2-1", title: "Voiceflow interfeiss un pirmais projekts", type: "video" as LessonType, duration: "18 min", description: "Orientācija Voiceflow kanvassā — Flows, KB, Variables. Izveido projektu un pirmajā Start bloku." },
        { id: "2-2", title: "AI bloks — sistēmas promts un konfigurācija", type: "video" as LessonType, duration: "22 min", description: "AI Response bloka iestatīšana, modeļa izvēle (GPT-4o mini vs Claude Haiku), sistēmas promta veidošana." },
        { id: "2-3", title: "Quick Reply pogas un zarošanās loģika", type: "video" as LessonType, duration: "16 min", description: "Sveiciena ziņa ar ātrās atbildes pogām — Par mums, Cenas, Sazināties. Katra poga ved uz savu celiņu." },
        { id: "2-4", title: "Testēšana Preview režīmā", type: "video" as LessonType, duration: "12 min", description: "Preview rīks — kā simulēt reālu klientu sarunu. 10 testjautājumi ko vienmēr jāpārbauda." },
        { id: "2-5", title: "Uzdevums: pirmais chatbots no nulles", type: "task" as LessonType, duration: "17 min", description: "Izveido funkcionālu chatbotu kādam vietējam biznesam (restorāns, frizētava u.c.) ar vismaz 3 sarunu celiņiem." },
      ],
    },
    {
      id: 3,
      title: "Knowledge Base & Personalizācija",
      duration: "1h 5 min",
      lessons: [
        { id: "3-1", title: "Knowledge Base — klienta lapas saturs kā dati", type: "video" as LessonType, duration: "20 min", description: "Kā pievienot URL, PDF un manuālu tekstu Voiceflow KB. Vector search un kāpēc AI saprot netieši formulētus jautājumus." },
        { id: "3-2", title: "Sistēmas promta optimizācija ar reāliem datiem", type: "video" as LessonType, duration: "18 min", description: "Pilns sistēmas promts ar cenu sarakstu, darba laikiem, kontaktinformāciju — template ar 8 obligātajiem blokiem." },
        { id: "3-3", title: "Lead ievākšana — Capture bloks", type: "video" as LessonType, duration: "14 min", description: "Capture bloka iestatīšana vārda un e-pasta ievākšanai. Datu nosūtīšana uz Google Sheets vai e-pastu." },
        { id: "3-4", title: "Uzdevums: KB ar reālu uzņēmumu datiem", type: "task" as LessonType, duration: "13 min", description: "Izveido Knowledge Base no reāla (vai fiktīva) Latvijas uzņēmuma mājas lapas. Testē 15 dažādus jautājumus." },
      ],
    },
    {
      id: 4,
      title: "Embed & Integrācija",
      duration: "55 min",
      lessons: [
        { id: "4-1", title: "Voiceflow embed kods un vizuālā pielāgošana", type: "video" as LessonType, duration: "15 min", description: "Publish → Web Chat → Embed code. Krāsu, nosaukuma un pozīcijas pielāgošana zīmolam." },
        { id: "4-2", title: "Framer integrācija — Custom Code", type: "video" as LessonType, duration: "14 min", description: "Site Settings → Custom Code → End of body. Chatbots aktīvs Framer lapā 5 minūtēs." },
        { id: "4-3", title: "WordPress un citas platformas", type: "video" as LessonType, duration: "14 min", description: "WordPress Theme Editor (footer.php), Squarespace Code Injection, Wix Custom Code — visas 4 platformas." },
        { id: "4-4", title: "Mobilās versijas testēšana un kļūdas", type: "text" as LessonType, duration: "12 min", description: "Biežākās 5 kļūdas pēc embed — chatbots slēpjas, neizgaismo, darbojas tikai desktop. Risinājumi katrai." },
      ],
    },
    {
      id: 5,
      title: "Pielāgots chatbots ar n8n",
      duration: "1h 40 min",
      lessons: [
        { id: "5-1", title: "HTML/JS widget — chatbota poga un logs", type: "video" as LessonType, duration: "25 min", description: "Pilna custom chatbota frontend izveide — bubble poga, dialoga logs, ziņu attēlošana un CSS stilizācija." },
        { id: "5-2", title: "n8n Webhook + Claude API backend", type: "video" as LessonType, duration: "28 min", description: "n8n workflow no Webhook trigera līdz Claude API pieprasījumam un atbildes atgriešanai. CORS konfigurācija." },
        { id: "5-3", title: "Sarunu atmiņa ar Google Sheets", type: "video" as LessonType, duration: "18 min", description: "sessionId bāzēta atmiņa — n8n lasa iepriekšējo vēsturi no Sheets, AI atceras kontekstu." },
        { id: "5-4", title: "Deployment un testēšana", type: "video" as LessonType, duration: "16 min", description: "n8n Activate, widget pievienošana lapai, end-to-end testēšana ar reāliem jautājumiem." },
        { id: "5-5", title: "Uzdevums: deploy savu n8n chatbotu", type: "task" as LessonType, duration: "13 min", description: "Izveido un uzstādi darboties n8n + Claude chatbotu uz reālas vai testa mājas lapas. Ekrānuzņēmums kā pierādījums." },
      ],
    },
    {
      id: 6,
      ...
      duration: "55 min",
      lessons: [
        { id: "6-1", title: "Kur atrast pirmos klientus Latvijā", type: "video" as LessonType, duration: "20 min", description: "Konkrētas vietas: uzņēmumu mājas lapu audits bez chatbota, LinkedIn, Facebook grupas, vietēji pasākumi." },
        { id: "6-2", title: "Demo chatbots kā pārdošanas rīks", type: "video" as LessonType, duration: "18 min", description: "Kā izveidot demo chatbotu konkrētam klientam pirms pirmās tikšanās — 'skatieties, tas jau darbojas jūsu lapā'." },
        { id: "6-3", title: "Piedāvājums, līgums un apkopes modelis", type: "text" as LessonType, duration: "17 min", description: "Lejupielādējams PDF piedāvājums ar 3 paketēm (€150/350/700) un vienkāršs apkopes līgums latviešu valodā." },
      ],
    },
  ] as Module[],
};
...
const ABorder2 = `rgba(0,212,255,0.2)`;
...
function ChatbotSidebarIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      <path d="M4 4h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H8l-4 4V6a2 2 0 0 1 2-2z" fill="url(#cb-g)" opacity="0.2" stroke="url(#cb-g)" strokeWidth="1.5"/>
      <circle cx="8.5" cy="11" r="1.5" fill="url(#cb-g)"/>
      <circle cx="12" cy="11" r="1.5" fill="url(#cb-g)"/>
      <circle cx="15.5" cy="11" r="1.5" fill="url(#cb-g)"/>
      <defs>
        <linearGradient id="cb-g" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse">
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 48 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
        ...
        <div style={{ position: "relative", padding: "40px", borderRadius: 20, background: "linear-gradient(135deg, rgba(0,255,136,0.08) 0%, rgba(0,212,255,0.05) 60%, rgba(5,5,8,0) 100%)", border: `1px solid ${ABorder}`, overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", top: -60, right: -60, width: 260, height: 260, borderRadius: "50%", background: "radial-gradient(circle, rgba(0,212,255,0.1), transparent 70%)", pointerEvents: "none" }} />
          ...
          <div style={{ position: "relative" }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "4px 12px", borderRadius: 20, background: ABg, border: ABorder, marginBottom: 20 }}>
              ...
              <span style={{ fontSize: 11, color: A, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase" }}>WhatsApp AI aģents</span>
            </div>

            <h2 style={{ fontSize: 32, fontWeight: 900, letterSpacing: "-0.03em", lineHeight: 1.1, marginBottom: 14, color: "#fff" }}>
              Izveido WhatsApp AI aģentu,<br />
              <span style={{ background: AG, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>kas strādā tavā vietā</span>
            </h2>

            <p style={{ fontSize: 15, color: "#888", lineHeight: 1.75, maxWidth: 620 }}>
              Ne tikai chatbot — bet inteliģents WhatsApp aģents, kas automātiski atbild, filtrē un konvertē klientus 24/7
            </p>
          </div>
        </div>
        ...
        <div style={{ padding: "28px 32px", borderRadius: 16, background: "#0d0d1a", border: "1px solid rgba(255,255,255,0.06)", display: "flex", alignItems: "flex-start", gap: 20 }}>
          <div style={{ width: 48, height: 48, borderRadius: 14, flexShrink: 0, background: "linear-gradient(135deg, rgba(0,255,136,0.2), rgba(0,212,255,0.2))", border: `1px solid ${ABorder}`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22 }}>
            💬
          </div>
          <div>
            ...
            <p style={{ fontSize: 15, color: "#ccc", lineHeight: 1.75 }}>
              Tu iemācīsies izveidot pilnu WhatsApp automatizācijas sistēmu — no automātiskām atbildēm līdz pieteikumu apstrādei un klientu filtrēšanai, kas biznesam ietaupa stundas katru dienu
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid-3" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 14 }}>
            {[
              ...
              { icon: "💰", color: "#f59e0b", title: "€300–800 par projektu", desc: "Pakalpojums, ko Latvijas uzņēmumi aktīvi meklē un maksā par to" },
            ].map((item) => (
              <div
                key={item.title}
        ...
        <div className="grid-2-fixed" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
          ...
          <div style={{ padding: "24px", borderRadius: 16, background: "#0d0d1a", border: `1px solid rgba(0,255,136,0.12)` }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {[
                "Spēju izveidot pilnu WhatsApp AI aģentu no nulles",
                "Sapratni, kā savienot n8n ar Claude API un WhatsApp",
                "Automatizētu pieteikumu apstrādes sistēmu",
                "Klientu filtrēšanas un follow-up workflow",
                "Iespēju piedāvāt biznesiem pilnu risinājumu par €300–800",
              ].map((item, i) => (
                <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                  <div style={{ width: 18, height: 18, borderRadius: 5, background: "rgba(0,255,136,0.15)", border: `1px solid rgba(0,255,136,0.35)`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: 1 }}>
          ...
          <div style={{ padding: "24px", borderRadius: 16, background: "#0d0d1a", border: `1px solid rgba(0,212,255,0.12)` }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: A2, textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: 16 }}>Automatizācijas, ko apgūsi</div>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {[
                "WhatsApp automātiskās atbildes ar AI",
                "Pieteikumu ievākšana un apstrāde",
                "Follow-up ziņas pēc noteikta laika",
                "Klientu filtrēšana pēc vajadzībām",
                "Google Sheets — sarunu vēsture un CRM",
              ].map((item, i) => (
                <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                  <div style={{ width: 18, height: 18, borderRadius: 5, background: "rgba(0,212,255,0.12)", border: "1px solid rgba(0,212,255,0.3)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: 1 }}>
        ...
        <div style={{ padding: "28px 32px", borderRadius: 16, background: "rgba(0,255,136,0.04)", border: `1px solid rgba(0,255,136,0.14)` }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: A, textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: 16 }}>Rezultāts — tu pārdosi sistēmu, ne tikai atbildes</div>
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            {[
              { icon: "📲", text: "Atbild klientiem" },
              { icon: "🎯", text: "Filtrē pieteikumus" },
              { icon: "⏱️", text: "Ietaupa 3+ h/dienā" },
            ].map((r) => (
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {[
              "Ja gribi piedāvāt biznesiem augstvērtīgu automatizācijas risinājumu",
              "Ja gribi pelnīt €300–800 par vienu projektu",
              "Ja gribi kaut ko, ko citi Latvijā vēl nepiedāvā",
            ].map((item, i) => (
        ...
        <div style={{ padding: "40px", borderRadius: 20, textAlign: "center", background: `linear-gradient(135deg, ${ABg}, ${ABg2})`, border: ABorder, position: "relative", overflow: "hidden" }}>
          <div style={{ position: "absolute", inset: 0, pointerEvents: "none", backgroundImage: `linear-gradient(${ABg} 1px, transparent 1px), linear-gradient(90deg, ${ABg} 1px, transparent 1px)`, backgroundSize: "32px 32px" }} />
          <div style={{ position: "relative" }}>
            <p style={{ fontSize: 14, color: "#555", marginBottom: 6 }}>Lielākā daļa uzņēmumu atbild ar nokavēšanos vai nemaz.</p>
            ...
            <button
              style={{ padding: "15px 44px", borderRadius: 12, border: "none", cursor: "pointer", background: AG, color: "#000", fontWeight: 700, fontSize: 15, letterSpacing: "0.01em", boxShadow: "0 8px 32px rgba(0,255,136,0.3)", transition: "transform 0.2s, box-shadow 0.2s" }}
              onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.transform = "translateY(-2px)"; (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 14px 40px rgba(0,255,136,0.45)"; }}
              onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.transform = "translateY(0)"; (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 8px 32px rgba(0,255,136,0.3)"; }}
            >
              Izveidot savu pirmo WhatsApp AI aģentu
            </button>
          </div>
        </div>
          ...
          {course.modules.map((mod) => (
            <div key={mod.id} style={{ padding: "16px", borderRadius: 12, background: "#0d0d1a", border: "1px solid rgba(255,255,255,0.06)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
                <div style={{ width: 24, height: 24, borderRadius: 6, background: ABg, border: `1px solid ${ABorder}`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 800, color: A }}>
                  {mod.id}
                </div>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: 20, padding: "24px", borderRadius: 16, background: "#0d0d1a", border: "1px solid rgba(255,255,255,0.06)" }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: "flex", gap: 20 }}>
              ...
              <div><div style={{ fontSize: 18, fontWeight: 800, color: "#f59e0b" }}>4.8 ★</div><div style={{ fontSize: 11, color: "#555" }}>vidējais vērtējums</div></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: "36px", borderRadius: 20, background: `linear-gradient(135deg, ${ABg}, ${ABg2})`, border: `1px solid ${ABorder}`, textAlign: "center" }}>
        ...
        <button
          style={{ padding: "14px 40px", borderRadius: 12, border: "none", cursor: "pointer", background: AG, color: "#000", fontWeight: 700, fontSize: 15, boxShadow: "0 8px 30px rgba(0,255,136,0.3)", transition: "transform 0.2s, box-shadow 0.2s" }}
          onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.transform = "translateY(-2px)"; (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 12px 40px rgba(0,255,136,0.4)"; }}
          onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.transform = "translateY(0)"; (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 8px 30px rgba(0,255,136,0.3)"; }}
        >
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
      ...
      {course.modules.map((mod) => {
        ...
        return (
          <div key={mod.id} style={{ borderRadius: 12, overflow: "hidden", border: isOpen ? `1px solid rgba(0,255,136,0.2)` : "1px solid rgba(255,255,255,0.06)", background: "#0d0d1a", transition: "border-color 0.2s" }}>
...
function ToolsTab() {
  const toolEmoji: Record<string, string> = {
    "Voiceflow": "🤖", "n8n": "⚡", "Claude API": "🧠",
    "Tidio": "💬", "JavaScript": "💻", "Google Sheets": "📊", "Framer / WP": "🌐",
  };
  return (
    <div>
      ...
      <div style={{ padding: "24px", borderRadius: 14, background: ABg, border: `1px solid rgba(0,255,136,0.12)` }}>
        ...
        <div className="grid-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
          {[
            ...
            "~€10–30/mēn rīku izmaksas (sākumā)",
...
function LessonView({ lesson, onBack }: { lesson: Lesson; onBack: () => void }) {
  return (
    <div className="lesson-pad" style={{ maxWidth: 860, margin: "0 auto", padding: "40px 48px" }}>
      ...
      {lesson.type === "video" && (
        <div
          style={{ width: "100%", aspectRatio: "16/9", borderRadius: 16, marginBottom: 32, background: "linear-gradient(135deg, #0a1510 0%, #081520 100%)", border: `1px solid rgba(0,255,136,0.2)`, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16, cursor: "pointer", position: "relative", overflow: "hidden", transition: "border-color 0.2s" }}
        ...
        >
          ...
          <div style={{ position: "absolute", width: 300, height: 300, background: `radial-gradient(circle, rgba(0,255,136,0.08), transparent 70%)`, pointerEvents: "none" }} />
          <div style={{ width: 72, height: 72, borderRadius: "50%", background: `linear-gradient(135deg, rgba(0,255,136,0.25), rgba(0,212,255,0.25))`, border: `2px solid ${ABorder}`, display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
      ...
      {lesson.type === "task" && (
        <div style={{ padding: "24px", borderRadius: 12, marginBottom: 24, background: ABg, border: `1px solid rgba(0,255,136,0.15)` }}>
          ...
          <button style={{ marginTop: 16, padding: "10px 24px", borderRadius: 8, cursor: "pointer", background: "rgba(0,255,136,0.15)", border: `1px solid rgba(0,255,136,0.3)`, color: A, fontWeight: 700, fontSize: 13, transition: "background 0.2s" }} onMouseEnter={(e) => (e.currentTarget.style.background = "rgba(0,255,136,0.25)")} onMouseLeave={(e) => (e.currentTarget.style.background = "rgba(0,255,136,0.15)")}>
            Iesniegt uzdevumu
          </button>
        </div>
      )}
      ...
      {lesson.type === "text" && (
        <div style={{ padding: "24px", borderRadius: 12, marginBottom: 24, background: "rgba(0,212,255,0.04)", border: "1px solid rgba(0,212,255,0.12)" }}>
          ...
          <button style={{ padding: "10px 24px", borderRadius: 8, cursor: "pointer", background: "rgba(0,212,255,0.12)", border: "1px solid rgba(0,212,255,0.25)", color: A2, fontWeight: 700, fontSize: 13, transition: "background 0.2s" }} onMouseEnter={(e) => (e.currentTarget.style.background = "rgba(0,212,255,0.2)")} onMouseLeave={(e) => (e.currentTarget.style.background = "rgba(0,212,255,0.12)")}>
            ↓ Lejupielādēt (PDF)
          </button>
        </div>
      )}
      ...
      <div style={{ display: "flex", justifyContent: "space-between", paddingTop: 24, borderTop: "1px solid rgba(255,255,255,0.06)", marginTop: 8 }}>
        ...
        <button
          style={{ padding: "10px 24px", borderRadius: 8, border: "none", cursor: "pointer", background: AG, color: "#000", fontSize: 13, fontWeight: 700, boxShadow: "0 4px 16px rgba(0,255,136,0.25)", transition: "transform 0.2s, box-shadow 0.2s" }}
          onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.transform = "translateY(-1px)"; (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 8px 24px rgba(0,255,136,0.35)"; }}
          onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.transform = "translateY(0)"; (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 4px 16px rgba(0,255,136,0.25)"; }}
        >
          Nākamā nodarbība →
        </button>
      </div>
