            ...
            <div style={{ background: `rgba(${PLAN.glow},0.08)`, padding: "20px 24px", borderBottom: `1px solid rgba(${PLAN.glow},0.15)` }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <span style={{ fontSize: 15, fontWeight: 800, color: PLAN.color }}>€1 600–€4 500/mēn</span>
                </div>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <span style={{ fontSize: 18, fontWeight: 900, color: PLAN.color }}>€3 200–€9 000/mēn</span>
                </div>
              </div>
            </div>
